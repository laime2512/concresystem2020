...
public class Producto implements Serializable{
	...
	public String toString() {
		return "Producto [codpro=" + codpro + ", codlab=" + codlab + ", codmed=" + codmed + ", codare=" + codare
				+ ", estado=" + estado + ", codtip=" + codtip + ", unixcaja=" + unixcaja + ", nombre=" + nombre
				+ ", tipoCompra=" + tipoCompra + ", presentacionUnidad=" + presentacionUnidad + ", presentacionCaja="
				+ presentacionCaja + ", presentacionPaquete=" + presentacionPaquete + ", generico=" + generico
				+ ", concentracion=" + concentracion + ", codigobarra=" + codigobarra + ", margen=" + margen + ", foto="
				+ foto + ", pareto=" + pareto + ", xtipo=" + xtipo + ", xlaboratorio=" + xlaboratorio + ", xmedida="
				+ xmedida + ", xarea=" + xarea + ", xcategoria=" + xcategoria + ", pcUnit=" + pcUnit + ", pvUnit="
				+ pvUnit + ", pvCaja=" + pvCaja + ", pcCaja=" + pcCaja + ", unixpaquete=" + unixpaquete
				+ ", uniEnPaquete=" + uniEnPaquete + ", inventarioMinimoCaja=" + inventarioMinimoCaja
				+ ", inventarioMinimoPaquete=" + inventarioMinimoPaquete + ", inventarioMinimoUnidad="
				+ inventarioMinimoUnidad + ", pcPaquete=" + pcPaquete + ", pvPaquete=" + pvPaquete
				+ ", pvDescuentoPaquete=" + pvDescuentoPaquete + ", pvDescuentoCaja=" + pvDescuentoCaja
				+ ", porcentajeUnidad=" + porcentajeUnidad + ", porcentajeCaja=" + porcentajeCaja
				+ ", porcentajePaquete=" + porcentajePaquete + ", porcentajeDescuentoCaja=" + porcentajeDescuentoCaja
				+ ", porcentajeDescuentoPaquete=" + porcentajeDescuentoPaquete + ", controlado=" + controlado + "]";
	}
