...
(function(c) {
    ...
    var q = {
        ...
        p = function() {
            f = c("body");
            PNotify.prototype.options.stack.context = f;
            h = c(window);
    ...
    c.extend(PNotify.prototype, {
        ...
        runModules: function(b, a) {
            var m, c;
            for (c in this.modules)
                if (
                    ((m = "object" === typeof a && c in a ? a[c] : a),
                        "function" === typeof this.modules[c][b])
                )
                    this.modules[c][b](
                        this,
                        "object" === typeof this.options[c] ? this.options[c] : {},
                        m
                    );
        },
        state: "initializing",
        ...
        init: function() {
            ...
            this.styles =
                ...
                PNotify.styling[this.options.styling];
            this.elem = c("<div />", {
            ...
            this.text_container = c("<div />", { class: "ui-pnotify-text" }).appendTo(
                this.container
            );
            !1 === this.options.text ?
            ...
            PNotify.notices =
                ...
                c.merge([this], PNotify.notices) :
                c.merge(PNotify.notices, [this]);
        ...
        update: function(b) {
            ...
            !1 === this.options.title ?
                ...
                (this.options.title_escape ?
                    this.title_container.text(this.options.title) :
                    this.title_container.html(this.options.title), !1 === a.title && this.title_container.slideDown(200));
            !1 === this.options.text ?
            ...
            if (
                ...
                this.container.find("div.ui-pnotify-icon").remove(), !1 !== this.options.icon &&
                c("<div />", { class: "ui-pnotify-icon" })
                .append(
                    c("<span />", {
                        class:
            ...
            this.options.opacity !== a.opacity &&
        ...
        open: function() {
            ...
            this.elem.parent().length ||
                this.elem.appendTo(
                    this.options.stack.context ? this.options.stack.context : f
                );
            "top" !== this.options.stack.push && this.position(!0);
            "fade" === this.options.animation ||
                "fade" === this.options.animation.effect_in ?
                this.elem
                .show()
                .fadeTo(0, 0)
                .hide() :
        ...
        parseOptions: function(b, a) {
            ...
            for (var m = [b, a], g, e = 0; e < m.length; e++) {
                g = m[e];
                if ("undefined" == typeof g) break;
                if ("object" !== typeof g) this.options.text = g;
                else
                    for (var d in g)
                        this.modules[d] ?
                        c.extend(!0, this.options[d], g[d]) :
                        (this.options[d] = g[d]);
            }
        },
        animateIn: function(b) {
            ...
            var a;
            a =
                "undefined" !== typeof this.options.animation.effect_in ?
                this.options.animation.effect_in :
                this.options.animation;
            "none" === a
                ?
                (this.elem.show(), b()) :
                "show" === a ?
                this.elem.show(this.options.animate_speed, b) :
                "fade" === a ?
                this.elem
                .show()
                .fadeTo(this.options.animate_speed, this.options.opacity, b) :
                "slide" === a ?
                this.elem.slideDown(this.options.animate_speed, b) :
                "function" === typeof a ?
                a("in", b, this.elem) :
                this.elem.show(
                    a,
                    "object" === typeof this.options.animation.options_in ?
                    this.options.animation.options_in :
                    {},
                    this.options.animate_speed,
                    b
                );
            this.elem.parent().hasClass("ui-effects-wrapper") &&
        ...
        animateOut: function(b) {
            ...
            var a;
            a =
                "undefined" !== typeof this.options.animation.effect_out ?
                this.options.animation.effect_out :
                this.options.animation;
            "none" === a
                ?
                (this.elem.hide(), b()) :
                "show" === a ?
                this.elem.hide(this.options.animate_speed, b) :
                "fade" === a ?
                this.elem.fadeOut(this.options.animate_speed, b) :
                "slide" === a ?
                this.elem.slideUp(this.options.animate_speed, b) :
                "function" === typeof a ?
                a("out", b, this.elem) :
                this.elem.hide(
                    a,
                    "object" === typeof this.options.animation.options_out ?
        ...
        position: function(b) {
            var a = this.options.stack,
                c = this.elem;
            c.parent().hasClass("ui-effects-wrapper") &&
                (c = this.elem
                    .css({ left: "0", top: "0", right: "0", bottom: "0" })
                    .parent());
            "undefined" === typeof a.context && (a.context = f);
            if (a) {
                ...
                if (!e || b) {
                    ...
                    "undefined" !== typeof a.firstpos1 ||
                        e ||
                        ((a.firstpos1 = b), (a.nextpos1 = a.firstpos1));
                    var l;
                    switch (a.dir2) {
                        case "down":
                            l = "top";
                    ...
                    n = parseInt(c.css(l).replace(/(?:\..*|[^0-9.])/g, ""));
                    isNaN(n) && (n = 0);
                    "undefined" !== typeof a.firstpos2 ||
                        e ||
                        ((a.firstpos2 = n), (a.nextpos2 = a.firstpos2));
                    if (
                        ("down" === a.dir1 &&
                            a.nextpos1 + c.height() >
                            (a.context.is(f) ?
                        ...
                        ("right" === a.dir1 &&
                            a.nextpos1 + c.width() >
                            (a.context.is(f) ? h.width() : a.context.prop("scrollWidth")))
                    )
                    ...
                    if ("number" === typeof a.nextpos1)
                        if (
                            a.animation &&
                            (b > a.nextpos1 || d.top || d.bottom || d.right || d.left)
                        )
                            switch (a.dir1) {
                                case "down":
                                    d.top = a.nextpos1 + "px";
        ...
        cancelRemove: function() {
            ...
            "closing" === this.state &&
                (this.elem.stop(!0),
                    ...
                    this.elem
                    .css("height", "auto")
                    .animate({ width: this.options.width, opacity: this.options.opacity },
                        "fast"
                    ));
            return this;
        },
    ...
    c.extend(PNotify, {
        ...
        positionAll: function(b) {
            ...
            if (PNotify.notices && PNotify.notices.length)
                ...
                var a = PNotify.prototype.options.stack;
...
(function(c) {
    "object" === typeof exports && "undefined" !== typeof module ?
        ...
        "function" === typeof define && define.amd ?
        define("pnotify.buttons", ["jquery", "pnotify"], c) :
        c(jQuery, PNotify);
})(function(c, e) {
        ...
        init: function(a, b) {
                ...
                mouseenter: function(b) {
                    !d.myOptions.sticker ||
                        (a.options.nonblock &&
                            ...
                            !d.myOptions.show_on_nonblock) ||
                        d.sticker.trigger("pnotify_icon").css("visibility", "visible");
                    !d.myOptions.closer ||
                        (a.options.nonblock &&
                            a.options.nonblock.nonblock &&
                            !d.myOptions.show_on_nonblock) ||
                        d.closer.css("visibility", "visible");
                },
                mouseleave: function(a) {
            ...
            this.sticker = c("<div />", {
                ...
                .bind("pnotify_icon", function() {
                    c(this)
                        .children()
                        .removeClass(a.styles.pin_up + " " + a.styles.pin_down)
                        .addClass(a.options.hide ? a.styles.pin_up : a.styles.pin_down);
                })
                .append(
                    c("<span />", { class: a.styles.pin_up, title: b.labels.stick })
                )
            ...
            this.closer = c("<div />", {
                ...
                .append(
                    c("<span />", { class: a.styles.closer, title: b.labels.close })
                )
                .prependTo(a.container);
            (!b.closer ||
                (a.options.nonblock &&
    ...
    c.extend(e.styling.brighttheme, {
...
(function(e) {
    ...
    d.prototype.modules.desktop = {
        ...
        update: function(a, b, d) {
            (0 !== c && b.fallback) || !b.desktop || this.genNotice(a, b);
        },
        beforeOpen: function(a, b) {
            (0 !== c && b.fallback) ||
            !b.desktop ||
                a.elem.css({ left: "-10000px", display: "none" });
        },
...
(function(a) {
    "object" === typeof exports && "undefined" !== typeof module ?
        ...
        "function" === typeof define && define.amd ?
        define("pnotify.mobile", ["jquery", "pnotify"], a) :
        a(jQuery, PNotify);
})(function(a, b) {});